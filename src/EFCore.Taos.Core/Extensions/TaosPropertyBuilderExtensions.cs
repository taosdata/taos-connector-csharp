    ...
    public static class TaosPropertyBuilderExtensions
    {
        ...
        public static bool CanSetSrid(
            ...
            => Check.NotNull(propertyBuilder, nameof(propertyBuilder)).CanSetAnnotation(
                TaosAnnotationNames.Srid,
                srid,
                fromDataAnnotation);

        /// <summary>
        ///     Configures the dimension of the column that the property maps to when targeting Taos.
        /// </summary>
        /// <param name="propertyBuilder"> The builder for the property being configured. </param>
        ...
        /// </returns>
        [Obsolete("Use HasSrid")]
        public static IConventionPropertyBuilder ForTaosHasSrid(
            [NotNull] this IConventionPropertyBuilder propertyBuilder,
            int? srid,
            bool fromDataAnnotation = false)
        ...
        public static IConventionPropertyBuilder ForTaosHasDimension(
            [NotNull] this IConventionPropertyBuilder propertyBuilder,
            [CanBeNull] string dimension,
            bool fromDataAnnotation = false)
